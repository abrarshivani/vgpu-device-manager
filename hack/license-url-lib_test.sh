...
assert_eq "github.com/!n!v!i!d!i!a/mig-parted" \
    "$(proxy_escape github.com/NVIDIA/mig-parted)" \
    "proxy_escape escapes only the uppercase segment"
...
assert_eq "https://github.com/google/gnostic-models" \
    "$(github_repo_from_path github.com/google/gnostic-models/openapiv2)" "github submodule"
...
assert_eq "openapiv2" \
    "$(github_subdir_from_path github.com/google/gnostic-models/openapiv2)" "github subdir"
...
assert_eq "https://github.com/NVIDIA/mig-parted" \
    "$(normalize_repo_url 'https://github.com/NVIDIA/mig-parted.git')" "strip .git"
assert_eq "https://github.com/foo/bar" \
    "$(normalize_repo_url 'https://github.com/foo/bar/')" "strip trailing slash"

assert_eq "pkg/nvlib" \
    "$(derived_subdir github.com/NVIDIA/go-nvlib/pkg/nvlib github.com/NVIDIA/go-nvlib)" \
    "subdir from prefix"
...
assert_eq "https://go.googlesource.com/net/+/refs/tags/v0.58.0/LICENSE" \
    "$(blob_url https://go.googlesource.com/net refs/tags/v0.58.0 LICENSE)" "gerrit blob template"

assert_eq "https://raw.githubusercontent.com/stretchr/testify/v1.12.1/internal/spew/LICENSE" \
    "$(raw_url_for https://github.com/stretchr/testify/blob/v1.12.1/internal/spew/LICENSE)" \
    "github raw URL"
assert_eq "https://go.googlesource.com/net/+/refs/tags/v0.58.0/LICENSE?format=TEXT" \
    "$(raw_url_for https://go.googlesource.com/net/+/refs/tags/v0.58.0/LICENSE)" "gerrit raw URL"
